#!/bin/sh
# Copyright (c) 2017-2019 The MicroBitcoin Core developers
...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the micro repository."
  exit 1
fi
...
# See https://github.com/MicroBitcoinOrg/MicroBitcoin/issues/16064
...
echo 'When compiling microd, run `./configure` in the following way:'
echo
