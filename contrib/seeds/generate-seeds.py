...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef MICRO_CHAINPARAMSSEEDS_H\n')
    g.write('#define MICRO_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the micro network\n')
    ...
    g.write('#endif // MICRO_CHAINPARAMSSEEDS_H\n')
