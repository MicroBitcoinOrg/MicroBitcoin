...
microbitcoin.org and compares them.
...
WORKINGDIR = "/tmp/micro_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://microbitcoin.org"
HOST2 = "https://micro.org"
VERSIONPREFIX = "micro-core-"
...
def main(args):
    ...
    if not success:
        print("micro.org failed to provide signature file, "
              "but microbitcoin.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("micro.org and microbitcoin.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the MicroBitcoin Core binary release "
