MicroBitcoin Core version 0.10.4 is now available from:

  <https://micro.org/bin/micro-core-0.10.4/>
...
- #6953 `43c2789` Split micro-tx into its own package
- #6953 `dfe0d4d` Include micro-tx binary on Debian/Ubuntu
