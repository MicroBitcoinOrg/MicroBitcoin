MicroBitcoin Core version 0.13.2 is now available from:

  <https://micro.org/bin/micro-core-0.13.2/>
...
- #8908 `4a974b2` Update micro-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow micro-tx to create v2 transactions (mbcdrak)
