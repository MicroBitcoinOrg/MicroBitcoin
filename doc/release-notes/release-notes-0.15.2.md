MicroBitcoin Core version *0.15.2* is now available from:

  <https://microbitcoin.org/bin/micro-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in micro-tx (TheBlueMatt)
