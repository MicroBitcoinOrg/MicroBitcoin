MicroBitcoin Core version 0.16.1 is now available from:

  <https://microbitcoin.org/bin/micro-core-0.16.1/>
...
- #12843 `df38b13` Test starting microd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure microd processes are cleaned up when tests end (sdaftuar)
