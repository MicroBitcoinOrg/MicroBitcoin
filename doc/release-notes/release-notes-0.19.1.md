...
MicroBitcoin Core version 0.19.1 is now available from:

  <https://microbitcoin.org/bin/micro-core-0.19.1/>
...
From MicroBitcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as MicroBitcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, MicroBitcoin Core does not yet change appearance when
...
- #17488 fix "microd already running" warnings on macOS (fanquake)
