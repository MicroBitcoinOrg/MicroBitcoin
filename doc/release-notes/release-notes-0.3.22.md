Download URL: https://sourceforge.net/projects/micro/files/MicroBitcoin/micro-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 MBC fee schedule (users still pay 0.01 MBC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #micro00 - #micro99
