MicroBitcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/micro/files/MicroBitcoin/micro-0.5.4/
...
http://gitorious.org/micro/microd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix MicroBitcoin-Qt notifications under Growl 1.3.
Increase required age of MicroBitcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMicroBitcoin properly when installing MicroBitcoin-Qt over it. (Windows)
