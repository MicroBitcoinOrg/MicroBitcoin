MicroBitcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/micro/files/MicroBitcoin/micro-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the MicroBitcoin
...
New/changed settings (command-line or micro.conf file)
--------------------------------------------------------
