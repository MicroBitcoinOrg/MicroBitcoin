MicroBitcoin Core version 0.9.2.1 is now available from:

  https://micro.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 MBC to 0.01 MBC
...
- Fix "Start micro on system login"
