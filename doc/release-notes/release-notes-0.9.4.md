MicroBitcoin Core version 0.9.4 is now available from:

  https://micro.org/bin/0.9.4/
...
this update is incompatible with the MicroBitcoin system and could lead to consensus
forks.

MicroBitcoin Core released binaries from https://micro.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~micro/+archive/ubuntu/micro
- A third-party or self-compiled MicroBitcoin Core

upgrade to MicroBitcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
