...
#ifndef MICRO_CRYPTO_CHACHA_POLY_AEAD_H
#define MICRO_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@micro.
 *
 ...
 *
 * The chacha20-poly1305@micro combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@micro cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@micro are relatively fast in
...
#endif // MICRO_CRYPTO_CHACHA_POLY_AEAD_H
