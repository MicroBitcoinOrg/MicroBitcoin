...
#ifndef MICRO_NODE_TRANSACTION_H
#define MICRO_NODE_TRANSACTION_H
 ...
 */
static const CFeeRate DEFAULT_MAX_RAW_TX_FEE_RATE{COIN / 10 * COIN_RATIO};
...
#endif // MICRO_NODE_TRANSACTION_H
