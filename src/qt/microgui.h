...
/**
  MicroBitcoin GUI main class. This class represents the main window of the MicroBitcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class MicroBitcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit MicroBitcoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~MicroBitcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a micro wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed MicroBitcoin Transaction from file or clipboard */
