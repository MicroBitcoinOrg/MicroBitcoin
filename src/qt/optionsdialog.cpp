    ...
    mapper(nullptr)
{
    ...
    ui->microAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->microAtStartup);
    ...
    ui->microAtStartup->setToolTip(ui->microAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->microAtStartup->setText(ui->microAtStartup->text().arg(PACKAGE_NAME));

    ui->openMicroBitcoinConfButton->setToolTip(ui->openMicroBitcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new MicroBitcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->microAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openMicroBitcoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openMicroBitcoinConf())
