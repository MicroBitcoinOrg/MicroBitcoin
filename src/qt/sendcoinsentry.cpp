    ...
    platformStyle(_platformStyle)
{
    ...
    // normal micro address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying micro address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &MicroBitcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
