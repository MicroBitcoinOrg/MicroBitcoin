...
//! Entry point for MicroBitcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &MicroBitcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for MicroBitcoinGUI tests.
void AppTests::guiTests(MicroBitcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &MicroBitcoinGUI::consoleShown, this, &AppTests::consoleTests);
