 ...
 *  A CTxDestination is the internal data type encoded in a micro address
 */
...
/**
 * Generate a MicroBitcoin scriptPubKey for the given CTxDestination. Returns a P2PKH
