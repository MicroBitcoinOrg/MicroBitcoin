...
#ifndef MICRO_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define MICRO_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // MICRO_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
