...
#ifndef MICRO_WALLET_ISMINE_H
#define MICRO_WALLET_ISMINE_H
 ...
 * https://github.com/MicroBitcoinOrg/MicroBitcoin/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
