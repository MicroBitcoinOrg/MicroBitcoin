...
#ifndef MICRO_WALLET_SCRIPTPUBKEYMAN_H
#define MICRO_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The MicroBitcoin wallet was originally a collection of unrelated private
...
#endif // MICRO_WALLET_SCRIPTPUBKEYMAN_H
