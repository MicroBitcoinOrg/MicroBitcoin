...
CWalletTx* CWallet::AddToWallet(CTransactionRef tx, const CWalletTx::Confirmation& confirm, const UpdateWalletTxFn& update_wtx, bool fFlushOnClose)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/MicroBitcoinOrg/MicroBitcoin/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/MicroBitcoinOrg/MicroBitcoin/pull/13339#issuecomment-461288094
...
void CWallet::transactionRemovedFromMempool(const CTransactionRef& tx, MemPoolRemovalReason reason, uint64_t mempool_sequence) {
    ...
    if (reason == MemPoolRemovalReason::CONFLICT) {
        ...
        //    https://github.com/MicroBitcoinOrg/MicroBitcoin/pull/18600#discussion_r420195993.
        ...
        //    https://github.com/MicroBitcoinOrg/MicroBitcoin/pull/9371 and the prior sync
        ...
        // https://github.com/micro-core/micro-devwiki/wiki/Wallet-Transaction-Conflict-Tracking
        SyncTransaction(tx, {CWalletTx::Status::UNCONFIRMED, /* block height */ 0, /* block hash */ {}, /* index */ 0});
    }
}
...
{
    const uint256& block_hash = block.GetIndexHash();
    LOCK(cs_wallet);
 ...
 * https://microtalk.org/?topic=54527, or
 * https://github.com/MicroBitcoinOrg/MicroBitcoin/pull/1393.
 */
