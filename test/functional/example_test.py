...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MicroBitcoinTestFramework
    pass


class ExampleTest(MicroBitcoinTestFramework):
    # Each functional test is a subclass of the MicroBitcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        MicroBitcoinTestFramework class so other tests can use it."""
