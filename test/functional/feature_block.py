#!/usr/bin/env python3
# Copyright (c) 2015-2020 The MicroBitcoin Core developers
...
class FullBlockTest(MicroBitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure microd isn't accepting b26
        ...
        # Extend the b28 chain to make sure microd isn't accepting b28
        ...
        # microd doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the micro code has custom code which does so);
