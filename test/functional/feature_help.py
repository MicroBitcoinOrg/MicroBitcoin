...
"""Verify that starting micro with -h works as expected."""

from test_framework.test_framework import MicroBitcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(MicroBitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start micro with -h for help text")
        ...
        self.log.info("Start micro with -version for version information")
        ...
        self.log.info("Start microd with -fakearg to make sure it does not start")
