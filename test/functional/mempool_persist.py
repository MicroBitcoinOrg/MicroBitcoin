...
By default, microd will dump mempool on shutdown and
...
class MempoolPersistTest(MicroBitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent microd from writing mempool.dat to disk. Verify that `savemempool` fails")
