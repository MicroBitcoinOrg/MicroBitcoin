...
class P2PPermissionsTests(MicroBitcoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].microconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].microconf, 'w', encoding="utf8") as f:
            f.write(newText)
