...
class TestShell:
    """Wrapper Class for MicroBitcoinTestFramework.

    The TestShell class extends the MicroBitcoinTestFramework
    ...
    class __TestShell(MicroBitcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by MicroBitcoinTestFramework child class.
            self.num_nodes = 1
