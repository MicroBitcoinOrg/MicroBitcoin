#!/usr/bin/env python3
# Copyright (c) 2020-2021 The MicroBitcoin Core developers
...
class OrphanedBlockRewardTest(MicroBitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # https://github.com/MicroBitcoinOrg/MicroBitcoin/issues/14148.
